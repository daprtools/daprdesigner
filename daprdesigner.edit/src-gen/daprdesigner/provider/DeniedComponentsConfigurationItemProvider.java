...
public class DeniedComponentsConfigurationItemProvider extends AppConfigurationItemProvider {
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_DeniedComponentsConfiguration_help_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_DeniedComponentsConfiguration_help_feature",
						"_UI_DeniedComponentsConfiguration_type"),
				DaprdesignerPackage.Literals.DENIED_COMPONENTS_CONFIGURATION__HELP, false, false, false,
