 ...
 * @generated
 */
public class WorkflowItemProvider extends BuildingBlockItemProvider {
	/**
	...
	protected void addAppIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Workflow_appID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Workflow_appID_feature",
								"_UI_Workflow_type"),
						DaprdesignerPackage.Literals.WORKFLOW__APP_ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
