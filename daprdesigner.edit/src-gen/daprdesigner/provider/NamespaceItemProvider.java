...
/**
 * This is the item provider adapter for a {@link daprdesigner.Namespace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamespaceItemProvider extends DaprNodeItemProvider {
	/**
	...
	protected void addRequiredFieldsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Namespace_requiredFields_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Namespace_requiredFields_feature",
								"_UI_Namespace_type"),
						DaprdesignerPackage.Literals.NAMESPACE__REQUIRED_FIELDS, false, false, false,
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Namespace_help_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Namespace_help_feature",
								"_UI_Namespace_type"),
						DaprdesignerPackage.Literals.NAMESPACE__HELP, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
