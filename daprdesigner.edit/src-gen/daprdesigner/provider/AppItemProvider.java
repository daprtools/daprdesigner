...
public class AppItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaprdesignerPackage.Literals.APP__CONFIGURATION);
		}
	...
	public String getText(Object object) {
		String label = ((App) object).getAppId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DaprdesignerPackage.Literals.APP__CONFIGURATION,
				DaprdesignerFactory.eINSTANCE.createAppConfiguration()));
	}
