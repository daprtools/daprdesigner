 ...
 * @generated
 */
public class NameResolutionConfigurationItemProvider extends AppConfigurationItemProvider {
	/**
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NameResolutionConfiguration_help_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_NameResolutionConfiguration_help_feature",
								"_UI_NameResolutionConfiguration_type"),
						DaprdesignerPackage.Literals.NAME_RESOLUTION_CONFIGURATION__HELP, false, false, false,
	...
	public String getText(Object object) {
		String label = ((NameResolutionConfiguration) object).getName();
