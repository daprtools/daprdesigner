...
public class RetryPolicyItemProvider extends DaprNodeItemProvider {
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RetryPolicy_help_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_RetryPolicy_help_feature",
								"_UI_RetryPolicy_type"),
						DaprdesignerPackage.Literals.RETRY_POLICY__HELP, false, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case DaprdesignerPackage.RETRY_POLICY__HELP:
