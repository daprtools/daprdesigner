...
public class SpecMetadataItemProvider extends DaprNodeItemProvider {
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SpecMetadata_help_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SpecMetadata_help_feature",
								"_UI_SpecMetadata_type"),
						DaprdesignerPackage.Literals.SPEC_METADATA__HELP, false, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case DaprdesignerPackage.SPEC_METADATA__HELP:
