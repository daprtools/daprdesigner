...
public class ResiliencyTargetItemProvider extends DaprNodeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaprdesignerPackage.Literals.RESILIENCY_TARGET__CIRCUIT_BREAKER);
			childrenFeatures.add(DaprdesignerPackage.Literals.RESILIENCY_TARGET__RETRY);
			childrenFeatures.add(DaprdesignerPackage.Literals.RESILIENCY_TARGET__TIMEOUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DaprdesignerPackage.Literals.RESILIENCY_TARGET__CIRCUIT_BREAKER,
				DaprdesignerFactory.eINSTANCE.createCircuitBreakerPolicy()));

		newChildDescriptors.add(createChildParameter(DaprdesignerPackage.Literals.RESILIENCY_TARGET__RETRY,
