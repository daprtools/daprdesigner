 ...
 * @generated
 */
public class TracingConfigurationItemProvider extends AppConfigurationItemProvider {
	/**
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_TracingConfiguration_help_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_TracingConfiguration_help_feature",
						"_UI_TracingConfiguration_type"),
				DaprdesignerPackage.Literals.TRACING_CONFIGURATION__HELP, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((TracingConfiguration) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		case DaprdesignerPackage.TRACING_CONFIGURATION__HELP:
