 ...
 * @generated
 */
public class CryptoGraphyItemProvider extends BuildingBlockItemProvider {
	/**
	...
	protected void addAppIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CryptoGraphy_appID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_CryptoGraphy_appID_feature",
								"_UI_CryptoGraphy_type"),
						DaprdesignerPackage.Literals.CRYPTO_GRAPHY__APP_ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
