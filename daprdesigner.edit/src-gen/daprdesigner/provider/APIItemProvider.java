...
public class APIItemProvider extends DaprNodeItemProvider {
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_API_help_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_API_help_feature", "_UI_API_type"),
						DaprdesignerPackage.Literals.API__HELP, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addApiTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_API_apiType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_API_apiType_feature", "_UI_API_type"),
						DaprdesignerPackage.Literals.API__API_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
