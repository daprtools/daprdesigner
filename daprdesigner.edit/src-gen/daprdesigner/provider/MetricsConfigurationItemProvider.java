 ...
 * @generated
 */
public class MetricsConfigurationItemProvider extends AppConfigurationItemProvider {
	/**
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MetricsConfiguration_help_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_MetricsConfiguration_help_feature",
						"_UI_MetricsConfiguration_type"),
				DaprdesignerPackage.Literals.METRICS_CONFIGURATION__HELP, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((MetricsConfiguration) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_MetricsConfiguration_type")
				: getString("_UI_MetricsConfiguration_type") + " " + label;
	}
