...
public interface DeniedComponentsConfiguration extends AppConfiguration {
	 ...
	 * The default value is <code>"https://docs.dapr.io/operations/configuration/configuration-overview/#disallow-usage-of-certain-component-types"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getDeniedComponentsConfiguration_Help()
	 * @model default="https://docs.dapr.io/operations/configuration/configuration-overview/#disallow-usage-of-certain-component-types" changeable="false"
	 * @generated
	 */
	String getHelp();
