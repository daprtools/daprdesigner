 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.AppAccessControl#getHelp <em>Help</em>}</li>
...
public interface AppAccessControl extends AppConfiguration {
	 ...
	 * The default value is <code>"https://docs.dapr.io/operations/configuration/invoke-allowlist/#access-control"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getAppAccessControl_Help()
	 * @model default="https://docs.dapr.io/operations/configuration/invoke-allowlist/#access-control" changeable="false"
	 * @generated
	 */
	String getHelp();
