 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.TracingConfiguration#getHelp <em>Help</em>}</li>
...
public interface TracingConfiguration extends AppConfiguration {
	 ...
	 * The default value is <code>"https://docs.dapr.io/operations/configuration/configuration-overview/#tracing"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getTracingConfiguration_Help()
	 * @model default="https://docs.dapr.io/operations/configuration/configuration-overview/#tracing" changeable="false"
	 * @generated
	 */
	String getHelp();
