...
public interface AppPolicy extends DaprNode {
	 ...
	 * The default value is <code>"https://docs.dapr.io/operations/configuration/invoke-allowlist/#policies"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getAppPolicy_Help()
	 * @model default="https://docs.dapr.io/operations/configuration/invoke-allowlist/#policies" changeable="false"
	 * @generated
	 */
	String getHelp();
