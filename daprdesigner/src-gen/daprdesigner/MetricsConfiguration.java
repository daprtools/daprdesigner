 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.MetricsConfiguration#getHelp <em>Help</em>}</li>
...
public interface MetricsConfiguration extends AppConfiguration {
	...
	/**
	 * Returns the value of the '<em><b>Latency Distribution Buckets</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Latency Distribution Buckets</em>' attribute.
	 * @see #setLatencyDistributionBuckets(String)
	 * @see daprdesigner.DaprdesignerPackage#getMetricsConfiguration_LatencyDistributionBuckets()
	 * @model
	 * @generated
	 */
	String getLatencyDistributionBuckets();

	/**
	 * Sets the value of the '{@link daprdesigner.MetricsConfiguration#getLatencyDistributionBuckets <em>Latency Distribution Buckets</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Latency Distribution Buckets</em>' attribute.
	 * @see #getLatencyDistributionBuckets()
	 * @generated
	 */
	void setLatencyDistributionBuckets(String value);
	 ...
	 * The default value is <code>"https://docs.dapr.io/operations/configuration/configuration-overview/#metrics"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getMetricsConfiguration_Help()
	 * @model default="https://docs.dapr.io/operations/configuration/configuration-overview/#metrics" changeable="false"
	 * @generated
	 */
	String getHelp();
