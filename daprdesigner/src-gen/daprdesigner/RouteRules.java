...
public interface RouteRules extends DaprNode {
	 ...
	 * The default value is <code>"https://docs.dapr.io/reference/resource-specs/subscription-schema/#spec-fields"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getRouteRules_Help()
	 * @model default="https://docs.dapr.io/reference/resource-specs/subscription-schema/#spec-fields" changeable="false"
	 * @generated
	 */
	String getHelp();
