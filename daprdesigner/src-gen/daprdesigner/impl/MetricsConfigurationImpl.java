 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.impl.MetricsConfigurationImpl#getHelp <em>Help</em>}</li>
 ...
 * @generated
 */
public class MetricsConfigurationImpl extends AppConfigurationImpl implements MetricsConfiguration {
	/**
	 ...
	 * @ordered
	 */
	protected static final String HELP_EDEFAULT = "https://docs.dapr.io/operations/configuration/configuration-overview/#metrics";
	...
	/**
	 * The default value of the '{@link #getLatencyDistributionBuckets() <em>Latency Distribution Buckets</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String LATENCY_DISTRIBUTION_BUCKETS_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getLatencyDistributionBuckets() <em>Latency Distribution Buckets</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLatencyDistributionBuckets()
	 * @generated
	 * @ordered
	 */
	protected String latencyDistributionBuckets = LATENCY_DISTRIBUTION_BUCKETS_EDEFAULT;
	 ...
	 * @generated
	 */
	public String getLatencyDistributionBuckets() {
	 ...
	 * @generated
	 */
	public void setLatencyDistributionBuckets(String newLatencyDistributionBuckets) {
		String oldLatencyDistributionBuckets = latencyDistributionBuckets;
		latencyDistributionBuckets = newLatencyDistributionBuckets;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DaprdesignerPackage.METRICS_CONFIGURATION__LATENCY_DISTRIBUTION_BUCKETS,
					oldLatencyDistributionBuckets, latencyDistributionBuckets));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DaprdesignerPackage.METRICS_CONFIGURATION__HELP:
			return getHelp();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DaprdesignerPackage.METRICS_CONFIGURATION__ENABLED:
			...
			return;
		case DaprdesignerPackage.METRICS_CONFIGURATION__LATENCY_DISTRIBUTION_BUCKETS:
			setLatencyDistributionBuckets((String) newValue);
			return;
		case DaprdesignerPackage.METRICS_CONFIGURATION__HTTP_INCREASED_CARDINALITY:
	...
	public void eUnset(int featureID) {
		...
		case DaprdesignerPackage.METRICS_CONFIGURATION__ENABLED:
			...
			return;
		case DaprdesignerPackage.METRICS_CONFIGURATION__LATENCY_DISTRIBUTION_BUCKETS:
			setLatencyDistributionBuckets(LATENCY_DISTRIBUTION_BUCKETS_EDEFAULT);
			return;
		case DaprdesignerPackage.METRICS_CONFIGURATION__HTTP_INCREASED_CARDINALITY:
	...
	public boolean eIsSet(int featureID) {
		...
		case DaprdesignerPackage.METRICS_CONFIGURATION__LATENCY_DISTRIBUTION_BUCKETS:
			return LATENCY_DISTRIBUTION_BUCKETS_EDEFAULT == null ? latencyDistributionBuckets != null
					: !LATENCY_DISTRIBUTION_BUCKETS_EDEFAULT.equals(latencyDistributionBuckets);
		case DaprdesignerPackage.METRICS_CONFIGURATION__HTTP_INCREASED_CARDINALITY:
