 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.impl.ResiliencyTargetImpl#getHelp <em>Help</em>}</li>
 ...
 *   <li>{@link daprdesigner.impl.ResiliencyTargetImpl#getAppsActorsOrWorkflows <em>Apps Actors Or Workflows</em>}</li>
 *   <li>{@link daprdesigner.impl.ResiliencyTargetImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResiliencyTargetImpl extends DaprNodeImpl implements ResiliencyTarget {
	 ...
	 * @ordered
	 */
	protected static final String HELP_EDEFAULT = "https://docs.dapr.io/operations/resiliency/targets/";
	...
	/**
	 * The cached value of the '{@link #getAppsActorsOrWorkflows() <em>Apps Actors Or Workflows</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAppsActorsOrWorkflows()
	 * @generated
	 * @ordered
	 */
	protected EList<App> appsActorsOrWorkflows;
	 ...
	 * @generated
	 */
	public EList<App> getAppsActorsOrWorkflows() {
		if (appsActorsOrWorkflows == null) {
			appsActorsOrWorkflows = new EObjectResolvingEList<App>(App.class, this,
					DaprdesignerPackage.RESILIENCY_TARGET__APPS_ACTORS_OR_WORKFLOWS);
		}
		return appsActorsOrWorkflows;
	}
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectResolvingEList<Component>(Component.class, this,
					DaprdesignerPackage.RESILIENCY_TARGET__COMPONENTS);
		}
		return components;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DaprdesignerPackage.RESILIENCY_TARGET__APPS_ACTORS_OR_WORKFLOWS:
			return getAppsActorsOrWorkflows();
		case DaprdesignerPackage.RESILIENCY_TARGET__COMPONENTS:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DaprdesignerPackage.RESILIENCY_TARGET__TIMEOUT:
			...
			return;
		case DaprdesignerPackage.RESILIENCY_TARGET__APPS_ACTORS_OR_WORKFLOWS:
			getAppsActorsOrWorkflows().clear();
			getAppsActorsOrWorkflows().addAll((Collection<? extends App>) newValue);
			return;
		case DaprdesignerPackage.RESILIENCY_TARGET__COMPONENTS:
			getComponents().clear();
	...
	public boolean eIsSet(int featureID) {
		...
		case DaprdesignerPackage.RESILIENCY_TARGET__TIMEOUT:
			return timeout != null;
		case DaprdesignerPackage.RESILIENCY_TARGET__APPS_ACTORS_OR_WORKFLOWS:
			return appsActorsOrWorkflows != null && !appsActorsOrWorkflows.isEmpty();
		case DaprdesignerPackage.RESILIENCY_TARGET__COMPONENTS:
