 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.impl.SecretsImpl#getName <em>Name</em>}</li>
 *   <li>{@link daprdesigner.impl.SecretsImpl#getAppID <em>App ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecretsImpl extends BuildingBlockImpl implements Secrets {
	/**
	...
	protected EClass eStaticClass() {
		return DaprdesignerPackage.Literals.SECRETS;
	}
	...
	public void setAppID(String newAppID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaprdesignerPackage.SECRETS__APP_ID, oldAppID,
					appID));
	}
