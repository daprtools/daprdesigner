...
public class DaprdesignerFactoryImpl extends EFactoryImpl implements DaprdesignerFactory {
	...
	public EObject create(EClass eClass) {
		...
		case DaprdesignerPackage.CONFIGURATION_STORE:
			return createConfigurationStore();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case DaprdesignerPackage.NODE_BLOCK_TYPE:
			return createNodeBlockTypeFromString(eDataType, initialValue);
		case DaprdesignerPackage.API_TYPE:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		case DaprdesignerPackage.NODE_BLOCK_TYPE:
			return convertNodeBlockTypeToString(eDataType, instanceValue);
		case DaprdesignerPackage.API_TYPE:
	 ...
	 * @generated
	 */
	public NodeBlocks createNodeBlocks() {
		NodeBlocksImpl nodeBlocks = new NodeBlocksImpl();
		return nodeBlocks;
	}
	...
	public SecretStore createSecretStore() {
		SecretStoreImpl secretStore = new SecretStoreImpl();
		return secretStore;
	}
	 ...
	 * @generated
	 */
	public ConfigurationStore createConfigurationStore() {
		ConfigurationStoreImpl configurationStore = new ConfigurationStoreImpl();
	 ...
	 * @generated
	 */
	public NodeBlockType createNodeBlockTypeFromString(EDataType eDataType, String initialValue) {
		NodeBlockType result = NodeBlockType.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	 ...
	 * @generated
	 */
	public String convertNodeBlockTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
