 ...
 * </p>
 * <ul>
 *   <li>{@link daprdesigner.impl.ConfigurationImpl#getName <em>Name</em>}</li>
 *   <li>{@link daprdesigner.impl.ConfigurationImpl#getAppID <em>App ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends BuildingBlockImpl implements Configuration {
	/**
	...
	protected EClass eStaticClass() {
		return DaprdesignerPackage.Literals.CONFIGURATION;
	}
	...
	public void setAppID(String newAppID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaprdesignerPackage.CONFIGURATION__APP_ID, oldAppID,
					appID));
	}
