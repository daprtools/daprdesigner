...
public interface NameResolutionConfiguration extends AppConfiguration {
	 ...
	 * The default value is <code>"https://docs.dapr.io/operations/configuration/configuration-overview/#name-resolution-component"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Help</em>' attribute.
	 * @see daprdesigner.DaprdesignerPackage#getNameResolutionConfiguration_Help()
	 * @model default="https://docs.dapr.io/operations/configuration/configuration-overview/#name-resolution-component" changeable="false"
	 * @generated
	 */
	String getHelp();
